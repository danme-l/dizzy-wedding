...
// hotel alt coordinates: 45.4930741,-73.6095431
...
const MapComponent = ({coords}) => {
  return (
    <MapContainer center={[45.503694, -73.529585]} zoom={13} style={{ height: '400px', width: '75%' }}>
      ...
      />
      <Marker position={[45.503694, -73.529585]} icon={defaultIcon}>
        <Popup>La Toundra</Popup>
      </Marker>
      <Marker position={[45.493007, -73.557359]} icon={defaultIcon}>
        <Popup>Hotel Alt</Popup>
      </Marker>
    </MapContainer>
  );
};
